    ...
    <ul>
        ...
        if(!empty($filters)){
            foreach ($filters as $k => $v){
                echo st()->load_template('layouts/modern/activity/elements/top-filter/' . $v['rs_filter_type'], '', array('title' => $v['title'], 'taxonomy' => $v['rs_filter_type_taxonomy']));
            }
        }
        ?>
    </ul>
                ...
                <div class="form-extra-field dropdown">
                    ...
                    <div class="dropdown-menu sort-menu" aria-labelledby="dropdownMenuSort">
                        ...
                        <div class="sort-item st-icheck">
                            <div class="st-icheck-item"><label> <?php echo __('New activity', ST_TEXTDOMAIN); ?><input class="service_order" type="radio" name="service_order_<?php echo $format; ?>" data-value="new" checked/><span class="checkmark"></span></label></div>
                        </div>
                        <div class="sort-item st-icheck">
