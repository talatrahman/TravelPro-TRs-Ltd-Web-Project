                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="advance-item facilities st-icheck">
                            ...
                            $temp_facilities = '';
                            if(!empty($tax)){
                                if(isset($tax['st_category_cars'])){
                                    if(!empty($tax['st_category_cars'])){
                                        $temp_facilities = $tax['st_category_cars'];
                                        $in_facilities = explode(',', $tax['st_category_cars']);
                                    }
                                }
                            }
                            ?>
                            <div class="item-title">
                                <h4><?php echo __( 'Car Types', ST_TEXTDOMAIN ) ?></h4>
                            </div>
                            <div class="item-content">
                                <div class="row">
                            ...
                            <input type="hidden" class="data_taxonomy" name="taxonomy[st_category_cars]" value="<?php echo $temp_facilities; ?>">
                        </div>
                    </div>
                </div>
            </div>
