            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-9">
                        ...
                        <h2 class="st-heading-section"><?php echo esc_html__( 'Facilities', ST_TEXTDOMAIN ) ?>
                            <a href="#" class="pull-right toggle-section"
                        ...
                        ?>
                        <div class="st-hr large"></div>
                        <h2 class="st-heading-section"><?php echo esc_html__( 'Rules', ST_TEXTDOMAIN ) ?>
                            <a href="#" class="pull-right toggle-section"
                        ...
                        <div class="widgets">
                            <div class="fixed-on-mobile" data-screen="992px">
                                ...
                                <div class="form-book-wrapper relative">
                                    <?php echo st()->load_template( 'layouts/modern/common/loader' ); ?>
                                    <div class="form-head">
                                        <?php echo wp_kses( sprintf( __( 'from <span class="price">%s</span> <span class="unit"> /night</span>', ST_TEXTDOMAIN ), TravelHelper::format_money( $price ) ), [ 'span' => [ 'class' => [] ] ] ) ?>
                                    </div>
