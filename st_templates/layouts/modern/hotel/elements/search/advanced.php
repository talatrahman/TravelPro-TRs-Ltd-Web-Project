                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="advance-item facilities st-icheck">
                            ...
                            $temp_facilities = '';
                            if(!empty($tax)){
                                if(isset($tax['hotel_facilities'])){
                                    if(!empty($tax['hotel_facilities'])){
                                        $temp_facilities = $tax['hotel_facilities'];
                                        $in_facilities = explode(',', $tax['hotel_facilities']);
                                    }
                                }
                            }
                            ?>
                            <div class="item-title">
                                <h4><?php echo __( 'Hotel Facilities', ST_TEXTDOMAIN ) ?></h4>
                            </div>
                            <div class="item-content">
                                <div class="row">
                            ...
                            <input type="hidden" class="data_taxonomy" name="taxonomy[hotel_facilities]" value="<?php echo $temp_facilities; ?>">
                        </div>
                    </div>
                </div>
            </div>
