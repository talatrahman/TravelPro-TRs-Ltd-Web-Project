...
if(!isset($fullwidth))
    $fullwidth = false;
$class = 'col-lg-4 col-md-4 col-sm-4 col-xs-6 item-service grid-item has-matchHeight';
if($fullwidth)
    $class = 'col-lg-3 col-md-3 col-sm-3 col-xs-6 item-service grid-item has-matchHeight';
?>
