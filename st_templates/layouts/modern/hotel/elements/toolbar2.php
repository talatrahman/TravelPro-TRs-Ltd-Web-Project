    ...
    <ul class="toolbar-action hidden-xs">
        <li>
            <div class="form-extra-field dropdown <?php echo $format == 'popup' ? 'popup-sort' : ''; ?>" style="margin-right: 0">
                <button class="btn btn-link dropdown" type="button" id="dropdownMenuSort" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-right: 0">
                ...
                <div class="dropdown-menu sort-menu" aria-labelledby="dropdownMenuSort">
                    ...
                    <div class="sort-item st-icheck">
                        ...
                        <div class="st-icheck-item"><label> <?php echo __('Low to High', ST_TEXTDOMAIN); ?><input class="service_order" type="radio" name="service_order_<?php echo $format; ?>"  data-value="price_asc"/><span class="checkmark"></span></label></div>
                        <div class="st-icheck-item"><label> <?php echo __('High to Low', ST_TEXTDOMAIN); ?><input class="service_order" type="radio" name="service_order_<?php echo $format; ?>"  data-value="price_desc"/><span class="checkmark"></span></label></div>
                    </div>
                    <div class="sort-item st-icheck">
