                        ...
                        <div class="btn-group">
                            ...
                            if (!empty($video_url)) {
                                ...
                                <a href="<?php echo esc_url($video_url); ?>"
                                   class="btn btn-transparent has-icon radius st-video-popup"><?php echo TravelHelper::getNewIcon('video-player', '#FFFFFF', '18px', '18px') ?><?php echo __('Tour Video', ST_TEXTDOMAIN) ?></a>
                            <?php } ?>
                                ...
                                <div class="st-title-wrapper">
                                    ...
                                    <?php if ($tour_program_style == 'style1') { ?>
                                        <span class="expand" data-ex="1"
                                              data-text-more="<?php echo __('Expand All', ST_TEXTDOMAIN); ?>"
                                              data-text-less="<?php echo __('Collapse All', ST_TEXTDOMAIN); ?>"><?php echo __('Expand All', ST_TEXTDOMAIN); ?></span>
                                    <?php } ?>
                                </div>
                                        ...
                                        <form id="form-booking-inpage" method="post" action="#booking-request">
                                            ...
                                            <div class="form-group form-more-extra st-form-starttime" <?php echo $starttime_value != '' ? '' : 'style="display: none"' ?>>
                                                <input type="hidden" data-starttime="<?php echo $starttime_value; ?>"
                                                       data-checkin="<?php echo $start; ?>"
                                                       data-checkout="<?php echo $end; ?>"
