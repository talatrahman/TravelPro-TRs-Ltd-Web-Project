                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="advance-item facilities st-icheck">
                            ...
                            $temp_facilities = '';
                            if(!empty($tax)){
                                if(isset($tax['rental_types'])){
                                    if(!empty($tax['rental_types'])){
                                        $temp_facilities = $tax['rental_types'];
                                        $in_facilities = explode(',', $tax['rental_types']);
                                    }
                                }
                            }
                            ?>
                            <div class="item-title">
                                <h4><?php echo __( 'Rental Types', ST_TEXTDOMAIN ) ?></h4>
                            </div>
                            <div class="item-content">
                                <div class="row">
                            ...
                            <input type="hidden" class="data_taxonomy" name="taxonomy[rental_types]" value="<?php echo $temp_facilities; ?>">
                        </div>
                    </div>
                </div>
            </div>
