                                ...
                                if ($tour_show_calendar == 'on'):
                                    ...
                                    <div class="row ">
                                        <div class="col-xs-12 col-sm-12">
                                            <label for="check_in"><strong><?php _e('Departure date', ST_TEXTDOMAIN) ?>: </strong></label>
                                        ...
                                        <div class="col-xs-12 col-sm-6 mt10">
                                            <label for="check_out"><strong><?php _e('Return date', ST_TEXTDOMAIN) ?>: </strong></label>
                            ...
                            <div class="row mt10">
                                <?php if (get_post_meta(get_the_ID(), 'hide_adult_in_booking_form', true) != 'on'): ?>
                                    <div class="col-xs-12 col-sm-4">
                                        <label for="label_adult_number"><strong><?php _e('Adults', ST_TEXTDOMAIN) ?>: </strong></label>
                                ...
                                <?php if (get_post_meta(get_the_ID(), 'hide_children_in_booking_form', true) != 'on'): ?>
                                    <div class="col-xs-12 col-sm-4">
                                        <label for="label_child_number"><strong><?php _e('Children', ST_TEXTDOMAIN) ?>: </strong></label>
                                ...
                                <?php if (get_post_meta(get_the_ID(), 'hide_infant_in_booking_form', true) != 'on'): ?>
                                    <div class="col-xs-12 col-sm-4">
                                        <label for="label_infant_number"><strong><?php _e('Infant', ST_TEXTDOMAIN) ?>: </strong></label>
