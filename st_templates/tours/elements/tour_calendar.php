<?php
    ...
    if($current_calendar_date)
        $attribute_current_date = 'data-current-date="'. esc_attr($current_calendar_date) .'"';
?>
<div class="row calendar-wrapper" data-post-id="<?php echo esc_attr($post_id_data); ?>" <?php echo $attribute_current_date; ?>>
