            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Sub heading in banner', ST_TEXTDOMAIN ),
                            'id'    => 'hotel_alone_room_sub_heading',
                            'type'  => 'text',
                            'desc' => __('Enter sub heading display below title in banner', ST_TEXTDOMAIN),
                        ...
                        [
                            'label' => __( 'Number of bathroom', ST_TEXTDOMAIN ),
                            'id'    => 'bath_number',
                            'type'  => 'text',
                            'desc'  => __( 'Number of Bathroom', ST_TEXTDOMAIN ),
                            'std'   => 0,
                            'condition' => 'hotel_alone_room_layout:is(on)',
                        ],
                        [
