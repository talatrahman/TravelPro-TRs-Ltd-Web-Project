    ...
    class STAdminCars extends STAdmin
    {
        ...
        static function st_category_edit_output($object, $taxonomy)
        {
            ...
            <tr class="form-field term-image-wrap form-required">
                <th
                        for="destination-parent"><?php echo esc_html__('Featured Image', ST_TEXTDOMAIN); ?></th>
                <td>
                    ...
                    <button class="button button-small"
                            ...
                            title="<?php echo esc_html__('Select an image', ST_TEXTDOMAIN); ?>"
                            data-upload-text="<?php echo esc_html__('Select', ST_TEXTDOMAIN); ?>"><?php echo esc_html__('Select', ST_TEXTDOMAIN) ?></button>
        ...
        static function st_category_add_output()
        {
            ...
            <div class="form-field term-image-wrap">
                <label
                        for="destination-parent"><?php echo esc_html__('Featured Image', ST_TEXTDOMAIN); ?></label>
                <div class="destination-image">
                </div>
                <button class="button button-small"
                        id="add-destination-image"
            ...
            $this->metabox[] = [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'type' => 'on-off',
                        'desc' => __('Auto Transmission', ST_TEXTDOMAIN),
                    ],
                    [
                        'label' => __('Baggage', ST_TEXTDOMAIN),
                        'id' => 'baggage',
                        'type' => 'text',
                        'desc' => __('Baggage', ST_TEXTDOMAIN),
                    ],
                    [
                        'label' => __('No. Door', ST_TEXTDOMAIN),
                        'id' => 'door',
                        'type' => 'text',
                        'desc' => __('No. Door', ST_TEXTDOMAIN),
                    ],
                    ...
                    [
                        ...
                        'id' => 'fee_cancellation',
                        'type' => 'on-off',
                        'desc' => __('Free Cancellation', ST_TEXTDOMAIN),
                        'std' => 'on'
                    ],
                    [
                        ...
                        'id' => 'pay_at_pick_up',
                        'type' => 'on-off',
                        'desc' => __('Pay at Pick-up', ST_TEXTDOMAIN),
                        'std' => 'on'
                    ],
                    [
                        ...
                        'type' => 'on-off',
                        'desc' => __('Unlimited mileage', ST_TEXTDOMAIN),
                        'std' => 'on'
                    ],
                    [
                        ...
                        'id' => 'shuttle_to_car',
                        'type' => 'on-off',
                        'desc' => __('Shuttle to Car', ST_TEXTDOMAIN),
                        'std' => 'on'
                    ],
                    [
                    ...
                    [
                        'label'    => __( 'Equipment price', ST_TEXTDOMAIN ),
                        'id'       => 'extra_price',
                        'type'     => 'list-item',
                        'settings' => [
                            [
