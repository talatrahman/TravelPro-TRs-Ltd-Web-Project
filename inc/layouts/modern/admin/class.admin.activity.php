            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Min number of people', ST_TEXTDOMAIN ),
                            'id'    => 'min_people',
                            'type'  => 'text',
                            'desc'  => __( 'Min number of people', ST_TEXTDOMAIN ),
                            'std'   => '1',
                        ],
                        [
                        ...
                        [
                            ...
                            'label'    => __( "Activity program style", ST_TEXTDOMAIN ),
                            'type'     => 'select',
                            'choices' => [
                                [
                                    'label' => __( "Image with text", ST_TEXTDOMAIN ),
                                    'value' => 'style1'
                                ],
                                [
                                    'label' => __( "Background image", ST_TEXTDOMAIN ),
                                    'value' => 'style2'
                                ],
                                [
                                    'label' => __( "Text width icon", ST_TEXTDOMAIN ),
                                    'value' => 'style3'
                                ],
                            ],
                            'std' => 'style1'
                        ...
                        [
                            'id'       => 'activity_program',
                            'label'    => __( "Activity program", ST_TEXTDOMAIN ),
                            'type'     => 'list-item',
                        ...
                        [
                            ...
                            'settings' => [
                                [
                                    'id'    => 'time',
                                    'label' => __( 'Sub title', ST_TEXTDOMAIN ),
                                    'type'  => 'text',
                                ],
                                [
                                    'id'    => 'image',
