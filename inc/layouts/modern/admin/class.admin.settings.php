    ...
    class ST_Admin_Settings extends STAdmin
    {
        ...
        public function __partnerSettings()
        {
            return [/*------------- Option Partner Option --------------------*/
                    ...
                    [
                        ...
                        'desc'    => __( 'Header background of the partner page.', ST_TEXTDOMAIN ),
                        'type'    => 'upload',
                        'section' => 'option_partner'
                    ],
                    [
        ...
        public function __hotelAloneSettings()
        {
            return [/*----------- Hotel Alone Options--------------*/
                ...
                [
                    ...
                    'label'     => __( 'Select Single Hotel', ST_TEXTDOMAIN ),
                    'type'      => 'post-select-ajax',
                    'post_type' => 'st_hotel',
                    'sparam'    => 'posttype_select',
                    'section'   => 'option_hotel_alone',
                ...
                [
                    ...
                    'label'     => __( 'Number of posts per page room list', ST_TEXTDOMAIN ),
                    'type'      => 'text',
                    'section'   => 'option_hotel_alone',
                ],
                [
                    'id'        => 'st_hotel_alone_max_adult',
                    'label'     => __( 'Maximum number of adult in form search', ST_TEXTDOMAIN ),
                    'type'      => 'text',
                    'section'   => 'option_hotel_alone',
                ],
                [
                    'id'        => 'st_hotel_alone_max_child',
                    'label'     => __( 'Maximum number of children in form search', ST_TEXTDOMAIN ),
                    'type'      => 'text',
                    'section'   => 'option_hotel_alone',
                ],
                [
                    'id'      => 'st_hotel_alone_directly_book_now',
                    'label'   => esc_html__( 'Booking directly in room list page', ST_TEXTDOMAIN ),
                    'type'    => 'on-off',
                    'std' => 'off',
                    'section' => 'option_hotel_alone',
                ],
                [
                    ...
                    'label'   => esc_html__( 'Turn on/of single blog', ST_TEXTDOMAIN ),
                    'type'    => 'on-off',
                    'std' => 'off',
                    'section' => 'option_hotel_alone',
                ],
                [
                    ...
                    'label'     => __( 'Select taxonomy in page list of rooms', ST_TEXTDOMAIN ),
                    'type'      => 'st_select_tax',
                ...
                [
                    ...
                    'label'   => __( 'Select taxonomy in room detail page', ST_TEXTDOMAIN ),
                    'type'    => 'checkbox',
                    'section' => 'option_hotel_alone',
        ...
        public function __activitySettings()
        {
            return [/*------------- Activity Option  -----------------*/
                    ...
                    [
                        ...
                        'desc'    => __( 'Number of items on a activity results search page', ST_TEXTDOMAIN ),
                        'type'    => 'number',
                        'max'     => 50,
                        'min'     => 1,
                        'step'    => 1,
        ...
        public function __tourSettings()
        {
            return [/*------------- Activity - Tour Option  -----------------*/
                    ...
                    [
                        'id'        => 'tours_layout_v2',
                        'label'     => __( 'Tour Detail Layout', ST_TEXTDOMAIN ),
                        ...
                        'choices'   => [
                            [
                                'value' => '1',
                                'label' => __( 'Layout 1', ST_TEXTDOMAIN )
                            ],
                            [
                                'value' => '2',
                                'label' => __( 'Layout 2', ST_TEXTDOMAIN )
                            ],
                            [
                                'value' => '3',
                                'label' => __( 'Layout 3', ST_TEXTDOMAIN )
                            ]
            ...
            return [
                ...
                [
                    ...
                    'choices'   => [
                        ...
                        [
                            'id'  => '2',
                            'alt' => __( 'Transparent', ST_TEXTDOMAIN ),
                            'src' => get_template_directory_uri() . '/img/nav4.png'
                        ],
                        [
                            'id'  => '3',
                            'alt' => __( 'Header Lite', ST_TEXTDOMAIN ),
