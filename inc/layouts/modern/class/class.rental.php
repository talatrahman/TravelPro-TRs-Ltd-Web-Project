        ...
        public function st_filter_rental_ajax()
        {
            ...
            if ($query->have_posts()) {
                while ($query->have_posts()) {
                    ...
                    if ($is_popup_map) {
                        $popup_map .= '<div class="col-lg-6 col-md-6 col-xs-6 ">';
            ...
            <span class="count-string">
                ...
                if ($wp_query->found_posts):
                    ...
                    echo sprintf(__('%d - %d of %d %s', ST_TEXTDOMAIN), $posts_per_page * ($page - 1) + 1, $last, $wp_query->found_posts, ($wp_query->found_posts == 1 ? 'Rental' : 'Rentals'));
                endif;
                ?>
            </span>
            <?php
